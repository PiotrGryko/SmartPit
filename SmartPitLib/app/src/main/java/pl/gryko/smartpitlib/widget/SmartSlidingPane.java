...
public class SmartSlidingPane extends ViewGroup {
     ...
     */
    private int DEFAULT_OVERHANG_SIZE = 32; // dp;
    /**
    ...
    public void setDefaultOverhangSize(int size, Context context) {
        DEFAULT_OVERHANG_SIZE = size;
    ...
    public void setmSlideOffset(float offset)
    {
        mSlideOffset=offset;
    }
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(SmartSlidingPane parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(SmartSlidingPane parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            superNode.recycle();
            info.setClassName(SmartSlidingPane.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(SmartSlidingPane.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == SmartSlidingPane.this) {
